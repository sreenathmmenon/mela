...
- Sreenath subsequently rejected the homepage's heavy serif typography, font sizes and boxed beige styling. The discovery surface now uses restrained Instrument Sans typography, cool-neutral space, colourful per-game vector covers and compact navigation. Keep this styling scoped to discovery; game-stage physics, camera controls and authority are not visual-polish targets. Do not cite passing technical audits as proof that the user likes the design.
